    ...
    Promise.all([
      ...
      .then(([product, cats]) => {
        ...
        setForm({
          ...
          speeds: product.speeds ? String(product.speeds) : "",
          weightLbs: product.weightLbs ? String(product.weightLbs) : "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error?.formErrors?.[0] || "Failed to update product");
      }
