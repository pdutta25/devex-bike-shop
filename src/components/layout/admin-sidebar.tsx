...
const navItems = [
  ...
  { label: "Inventory", href: "/admin/inventory", icon: "M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" },
  ...
  { label: "Seed Data", href: "/admin/seed", icon: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" },
];
...
export function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-brand-dark text-white flex flex-col z-40">
      <div className="p-6 border-b border-gray-700">
        <Link href="/admin" className="text-xl font-bold tracking-tight">
          SSB <span className="text-amber-500">Admin</span>
        </Link>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-gray-800 text-amber-400 border-l-2 border-amber-400"
      ...
      <div className="p-4 border-t border-gray-700">
        <Link
          href="/"
          className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-400 hover:bg-gray-800 hover:text-gray-200 transition-colors"
        >
